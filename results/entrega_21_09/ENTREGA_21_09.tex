...
\source{Dados e protocolo | 31/08 revisado}{https://github.com/avilarenan/EAD6034/blob/f63a1048db3c36d2aeece3c8806be49f1be1a63c/src/ead6034/trading_time_data.py}
\end{frame}
...
\source{Aulas 2--4 | FAC/FACP convencionais}{https://github.com/avilarenan/EAD6034/blob/f63a1048db3c36d2aeece3c8806be49f1be1a63c/src/ead6034/annual_models.py}
\end{frame}
...
\source{Aula 5 | Estatísticas e valores críticos nas tabelas completas}{https://github.com/avilarenan/EAD6034/blob/f63a1048db3c36d2aeece3c8806be49f1be1a63c/src/ead6034/annual_models.py}
\end{frame}
...
\source{Aulas 3--4 | Box--Jenkins e alternativas lineares}{https://github.com/avilarenan/EAD6034/blob/f63a1048db3c36d2aeece3c8806be49f1be1a63c/src/ead6034/annual_models.py}
\end{frame}
...
\source{Aula 6 | Estabilidade, persistência e diagnóstico}{https://github.com/avilarenan/EAD6034/blob/f63a1048db3c36d2aeece3c8806be49f1be1a63c/src/ead6034/conditional_volatility.py}
\end{frame}
...
\source{Aula 4 | MSE, MAE, combinação e Diebold--Mariano}{https://github.com/avilarenan/EAD6034/blob/f63a1048db3c36d2aeece3c8806be49f1be1a63c/src/ead6034/forecast_evaluation.py}
\end{frame}
...
\source{Síntese cumulativa | Evidência, adequação e utilidade econômica são distintas}{https://github.com/avilarenan/EAD6034/blob/f63a1048db3c36d2aeece3c8806be49f1be1a63c/src/ead6034/forecast_pipeline.py}
\end{frame}
\begin{frame}[plain,noframenumbering]
