...
- **Código:** [construção e auditoria das séries](https://github.com/avilarenan/EAD6034/blob/f63a1048db3c36d2aeece3c8806be49f1be1a63c/src/ead6034/trading_time_data.py), [construção multiescala](https://github.com/avilarenan/EAD6034/blob/f63a1048db3c36d2aeece3c8806be49f1be1a63c/src/ead6034/multiscale.py). **Resultados:** [auditoria da sequência](https://github.com/avilarenan/EAD6034/blob/main/results/entrega_21_09/tables/sequence_audit.csv), [descrição mensal](https://github.com/avilarenan/EAD6034/blob/main/results/entrega_21_09/tables/monthly_description.csv).
...
- **Código:** [testes anuais](https://github.com/avilarenan/EAD6034/blob/f63a1048db3c36d2aeece3c8806be49f1be1a63c/src/ead6034/annual_models.py#L40). **Resultados:** [estatísticas, hipóteses e valores críticos](https://github.com/avilarenan/EAD6034/blob/main/results/entrega_21_09/tables/stationarity.csv).
...
Gerador: [Código](https://github.com/avilarenan/EAD6034/blob/f63a1048db3c36d2aeece3c8806be49f1be1a63c/src/ead6034/forecast_narrative.py).
